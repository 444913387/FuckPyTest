...
class HttpSender(GetDictParam):
    ...
    CASE_DATA_PATH = '/Users/wangjianyu/PycharmProjects/FuckPyTest/data/'

    @classmethod
    def getCaseData(cls, suitename):
        case_name = []
        url = []
        method = []
        params = []
        ...
        assert_text = []
        case_desc = []
        with open(cls.CASE_DATA_PATH + suitename + '.json', encoding='utf-8') as f:
